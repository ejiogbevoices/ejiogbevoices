...
export function SignUpForm() {
  ...
  return (
    <div className="w-full max-w-md bg-slate-900/50 border border-slate-800 rounded-lg p-8">
      <h2 className="text-2xl font-serif font-bold text-amber-400 mb-2">Join Ejiogbe Voices</h2>
      <p className="text-sm text-slate-400 mb-6">Create an account to preserve ancestral wisdom</p>
      ...
      <p className="text-center text-sm text-slate-400 mt-6">
        ...
        <Link href="/signin" className="text-slate-200 hover:text-amber-400">
          Log in
        </Link>
      </p>
