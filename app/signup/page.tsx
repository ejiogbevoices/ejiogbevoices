      ...
      <div className="min-h-screen bg-[#0D1117] flex flex-col items-center justify-center px-4 pb-20 md:pb-0">
        <div className="w-full max-w-md space-y-8">
          <div className="text-center">
            ...
            <p className="text-slate-400 text-balance mt-4">Click the link in the email to complete sign up.</p>
          </div>
          <Button
      ...
      <div className="flex-1 flex items-center justify-center">
        <div className="w-full max-w-md space-y-8">
          <div className="text-center space-y-3">
            <h1 className="text-5xl font-serif font-bold text-white text-balance">Join Ejiogbe Voices</h1>
            <p className="text-lg text-slate-400 text-balance">Create an account to preserve ancestral wisdom</p>
          </div>
          ...
          <div className="text-center">
            <Link href="/login" className="text-slate-400 hover:text-cyan-400 transition-colors underline">
